...
$notify.visible = $true
$notify.showballoontip(20,'WARNING','Timer started 40 Minutes ! Enjoy !!',[system.windows.forms.tooltipicon]::None)
...
$notify.showballoontip(20,'WARNING','You did **Great**, now Enjoy',[system.windows.forms.tooltipicon]::None)
& 'C:\Program Files\VideoLAN\VLC\vlc.exe' --qt-start-minimized --play-and-exit --qt-notification=0 "C:\Users\shu\Downloads\Start_alarm.mp3"
